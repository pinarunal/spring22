...
public class PassByValuePassByReference {
    ...
    2)By the help of "Pass By Valu" we are able to protect the original value.
    3)Some programming languages may use "Pass By Reference", if you use that kind of languages be careful
