...
public class Day02Variables {
    ...
    /*
        ...
        2)Non-Primitive Data Types
            ...
            String data type is used for multiple chracters.
        Note: What is the difference between "primitive" and "non-primitive" data types?
            i) Primitive data types starts with lowercases, "non-primitive" data types start with upper cases.
            ii) Primitive data types can be created  just by Java, but "non-primitive" data types  can be created by Java and Java developers.
